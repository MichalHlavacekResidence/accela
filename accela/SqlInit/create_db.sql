...
CREATE TABLE News (ID int(11) PRIMARY KEY AUTO_INCREMENT NOT NULL, Title VARCHAR(255) NOT NULL, Visibility Boolean, BrandID int(11) NOT NULL, FOREIGN KEY (BrandID) REFERENCES Brands(ID), ContactID int(11) NOT NULL, FOREIGN KEY (ContactID) REFERENCES Managers(ID), ImageBig text, ImageSmall text, Content text NOT NULL, ContentSmall text, Created Datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, VideoURL text);
